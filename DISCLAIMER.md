...
8.2 **Attribution.** Any Derivative must clearly and conspicuously state its relationship to the Project, including a link to the original Project repository (`https://github.com/LING71671/open-reverselab`) and a statement that the Derivative is not endorsed by or affiliated with the Project authors.
...
16.1 **Compromised or malicious copies.** Any person who forks, modifies, or redistributes a copy of the Project that introduces code, behavior, or functionality not present in the original — including backdoors, malware, spyware, trackers, miners, or any other malicious payload — does so at their own risk and on their own behalf. The Project authors bear no responsibility for the safety, integrity, or authenticity of any copy obtained from any source other than the original Project repository (`https://github.com/LING71671/open-reverselab`). The presence of the Project's name or attribution in a compromised copy does not constitute the Project authors' endorsement of or responsibility for that copy. Users are strongly urged to verify copies against the official repository before use. GPL-3.0 does not impose upon the Project authors any obligation to monitor, audit, or approve third-party modifications.
