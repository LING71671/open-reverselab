...
|---------|-------|-----------------|-----------|
| HTTP/Web/API/CVE/CAPTCHA | `ctf-website` | 21/75 | `http_probe` `run_ctf_tool` `kb_router` |
...
```
kb/
├── ctf-website/techniques/   21 类 75 篇 — Web 攻击全表面
...
| 板块 | 触发信号 |
|------|---------|
| `boards/ctf-website` | URL, HTTP, JWT, SQLi, SSRF, CVE, API, CSP, OAuth, CAPTCHA, Cloudflare |
